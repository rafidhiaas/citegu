                    ...
                    <div class="overflow-x-auto shadow-md sm:rounded-lg border border-gray-300 dark:border-gray-700 mb-8">
                        ...
                        <thead class="bg-gray-200 dark:bg-gray-700">
                            <tr>
                                ...
                                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-400 dark:text-blue-300 uppercase tracking-wider">Gambar</th> <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-400 dark:text-blue-300 uppercase tracking-wider">Deskripsi</th>
                            ...
                            @foreach($services as $service)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm">
                                        <i class="{{ $service->icon_class }}"></i></td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm">
                                    @if($service->image)
                                        <img src="{{ asset('storage/' . $service->image) }}" alt="{{ $service->name }} Gambar" class="h-10 w-8 object-contain">
                                    @else
