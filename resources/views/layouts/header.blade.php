<header id="header" class="header d-flex align-items-center fixed-top">
    <div class="header-container container-fluid container-xl position-relative d-flex align-items-center justify-content-end">
      ...
      <a href="{{ route('home') }}" class="logo d-flex align-items-center me-auto">
        <img src="{{ asset('landing/assets/img/logoctg1.png') }}" alt="CITEGU Logo">
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li><a href="{{ route('partners.public.index') }}" class="{{ Request::routeIs('partners.index') ? 'active' : '' }}">Our Partners</a></li>
          <!--  menyederhanakan kondisi active untuk 'About' agar aktif saat di halaman Home -->
          ...
          <a class="btn-getstarted" href="{{ route('contact.index') }}">Contact</a>
